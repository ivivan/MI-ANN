...
regressor = tf.estimator.DNNRegressor(
  feature_columns=feature_columns, hidden_units=[6,6,6],model_dir=r'C:\Users\ZHA244\Coding\tensorflow\logs',dropout=0.2)

# Train.
train_input_fn = tf.estimator.inputs.numpy_input_fn(
  x={'x': x_train}, y=y_train_do, batch_size=10, num_epochs=None, shuffle=False)
