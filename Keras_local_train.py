...
model_file = os.path.join('./bpnnpearson', '-{val_mean_squared_error:04f}-{epoch:02d}' + '.hdf5')
...
# trained_model = []
#
# trained_model = data_together(r'C:\Users\ZHA244\Coding\experiment\forfirstconf\models')
#
...
model = load_model('bpnnpearson/-0.368148-677.hdf5',custom_objects={'rsquare': rsquare})
score = model.evaluate(x_test, y_test_do, batch_size=1)
